...
const App = () => {
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Celular, username, ou email" style={styles.loginInput}></TextInput>
      <TextInput secureTextEntry={true} placeholder="Senha" style={styles.loginInput}></TextInput>
